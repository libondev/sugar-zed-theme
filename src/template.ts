...
export function getTemplate(
  ...
  return {
    ...
    style: {
      ...
      'text.muted': `${colors.foreground}bf`,
      'icon': colors.foreground,
      'icon.muted': `${colors.foreground}bf`,
      // contains inline_completions
      'predictive': colors.symbol,
      // file tree selected
      'element.selected': `${colors.accent}38`,
      'editor.gutter.background': colors.background,
      'editor.background': colors.background,
      'editor.foreground': colors.foreground,
      'editor.indent_guide_active': colors.accent,
      'editor.line_number': `${colors.foreground}60`,
      'editor.hover_line_number': `${colors.foreground}9f`,
      ...
      'version_control.added': colors.insert,
      'version_control.modified': colors.change,
      'version_control.deleted': colors.delete,
      'syntax': {
        'attribute': {
